            ...
            <form action="/index.php?m=admin&c=login&a=dologin" method="post">
                <ul class="admin_items">
                    <li>
                        ...
                        <input type="text" name="uname" value="" autocomplete="Off" size="40" class="admin_input_style" />
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <input type="test" name="code" value="" id="pwd" size="15" class="admin_input_style" />
                        <img style="vertical-align: top;"
                            onclick="this.src='/index.php?m=admin&c=login&a=code&x='+Math.random()" 
