    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php?m=admin&c=part&a=update&pid=<?=$part['pid']?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>分区名称：</th>
                                <td>
                                    <input class="common-text required" id="title" name="pname" size="50" value="<?=$part['pname']?>" type="text">
                                </td>
                            </tr>
