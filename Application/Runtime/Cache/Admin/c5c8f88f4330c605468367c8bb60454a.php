	...
	<div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/index.php?a=admin&c=user&a=update&uid=<?=$user['uid']?>"  method="post" id="myform" name="myform" enctype="multipart/form-data">
                        ...
                        <tbody><tr>
                            ...
                            <td>
                                <select name="auth" id="catid" class="required">
                                    ...
                                    <option <?php if($user['auth']==2){echo 'selected';} ?> value="2">管理员</option>
                                    <option <?php if($user['auth']==3){echo 'selected';} ?> value="3">普通会员</option>
                                </select>
                            </td>
                        </tr>
                            <tr>
